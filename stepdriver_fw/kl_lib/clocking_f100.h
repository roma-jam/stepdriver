...
#define CRYSTAL_FREQ_HZ     16000000     // Freq of external crystal, change accordingly
...
public:
    ...
    uint32_t ClockConfigure(Clk_input_t ClkInput,
            PllMul_t PllMul,
            AHBDiv_t AHBDiv, APBDiv_t APB1Div, APBDiv_t APB2Div,
            PLLState_t PLLState);
