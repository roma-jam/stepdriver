...
// ==== USB ====
#define EP0_SZ              64 // RJ must be 64
 ...
 */
//#define CCID_DATA_SZ        254 // May be greater than IFSC (254 max), this means chaining in Card.cpp
#define CCID_DATA_SZ        262  // Because PN DATA TRANSFER
